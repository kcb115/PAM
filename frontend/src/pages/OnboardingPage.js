  ...
  return (
    <div className="hero-gradient min-h-screen flex flex-col" data-testid="onboarding-page">
          ...
          <AnimatePresence mode="wait">
            {step === 1 && (
              ...
              >
                ...
                <div className="space-y-5">
                  ...
                  <div>
                    <Label htmlFor="phone_number" className="text-xs font-mono uppercase tracking-wider text-zinc-400 mb-2 flex items-center gap-2">
                      <span>📱</span> Phone Number <span className="text-zinc-600 normal-case font-normal">(for concert alerts via SMS)</span>
                    </Label>
                    <Input
                      id="phone_number"
                      type="tel"
                  ...
                  <div className="flex items-start gap-3">
                    <input
                      ...
                      className="mt-1 h-4 w-4 rounded border-white/10 bg-secondary/50 accent-[#380E75] cursor-pointer shrink-0"
                      data-testid="sms-consent-checkbox"
                    />
                    <label htmlFor="sms_consent" className="text-xs text-zinc-400 font-jakarta leading-relaxed cursor-pointer">
                      I agree to receive automated SMS concert recommendations from PAM at the intervals I have selected. Message and data rates may apply.
                    </label>
                  </div>
                </div>
                ...
                <Button
                  onClick={handleNext}
                  disabled={!form.sms_consent}
                  className="w-full mt-8 bg-[#380E75] text-[#DED5EB] font-syne font-bold uppercase tracking-wider rounded-full py-6 hover:bg-[#380E75]/80 transition-colors duration-200 disabled:opacity-40 disabled:cursor-not-allowed"
      ...
      <div className="text-center pb-8 text-xs text-zinc-600 font-jakarta">
        ...
        <Link to="/terms" className="underline hover:text-zinc-400 transition-colors">
          Terms & Conditions
        </Link>{" "}
        and{" "}
        <Link to="/privacy" className="underline hover:text-zinc-400 transition-colors">
          Privacy Policy
        </Link>
      </div>
    </div>
